...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyUserWorkspace :  IEquatable<ModifyUserWorkspace>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyUserWorkspace" /> class.
        /// </summary>
        ...
        public ModifyUserWorkspace(ModifyUserWorkspaceDetail workspace = default(ModifyUserWorkspaceDetail), string id = default(string), ModificationTypeEnum modificationType = default(ModificationTypeEnum))
        {
            // to ensure "workspace" is required (not null)
            if (workspace == null)
            {
                throw new InvalidDataException("workspace is a required property for ModifyUserWorkspace and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("modificationType is a required property for ModifyUserWorkspace and cannot be null");
            }
            else
            {
        ...
        public ModifyUserWorkspaceDetail Workspace { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyUserWorkspace {\n");
        ...
        {
            return this.Equals(input as ModifyUserWorkspace);
        }

        /// <summary>
        /// Returns true if ModifyUserWorkspace instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyUserWorkspace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyUserWorkspace input)
        {
            if (input == null)
                return false;
