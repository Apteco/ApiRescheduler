...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsChannelSummary :  IEquatable<PagedResultsChannelSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsChannelSummary" /> class.
        /// </summary>
        ...
        public PagedResultsChannelSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<ChannelSummary> _list = default(List<ChannelSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsChannelSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsChannelSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsChannelSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsChannelSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ChannelSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsChannelSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsChannelSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsChannelSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsChannelSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsChannelSummary input)
        {
            if (input == null)
                return false;
