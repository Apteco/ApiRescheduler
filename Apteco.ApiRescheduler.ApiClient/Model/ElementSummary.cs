...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ElementSummary :  IEquatable<ElementSummary>
    {
        /// <summary>
        /// The element&#x27;s type
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ElementSummary {\n");
        ...
        {
            return this.Equals(input as ElementSummary);
        }

        /// <summary>
        /// Returns true if ElementSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of ElementSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ElementSummary input)
        {
            if (input == null)
                return false;
