...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsShareUpdate :  IEquatable<PagedResultsShareUpdate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsShareUpdate" /> class.
        /// </summary>
        ...
        public PagedResultsShareUpdate(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<ShareUpdate> _list = default(List<ShareUpdate>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsShareUpdate and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsShareUpdate and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsShareUpdate and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsShareUpdate and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ShareUpdate> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsShareUpdate {\n");
        ...
        {
            return this.Equals(input as PagedResultsShareUpdate);
        }

        /// <summary>
        /// Returns true if PagedResultsShareUpdate instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsShareUpdate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsShareUpdate input)
        {
            if (input == null)
                return false;
