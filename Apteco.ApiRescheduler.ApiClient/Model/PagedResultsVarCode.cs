...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsVarCode :  IEquatable<PagedResultsVarCode>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsVarCode" /> class.
        /// </summary>
        ...
        public PagedResultsVarCode(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<VarCode> _list = default(List<VarCode>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsVarCode and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsVarCode and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsVarCode and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsVarCode and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<VarCode> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsVarCode {\n");
        ...
        {
            return this.Equals(input as PagedResultsVarCode);
        }

        /// <summary>
        /// Returns true if PagedResultsVarCode instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsVarCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsVarCode input)
        {
            if (input == null)
                return false;
