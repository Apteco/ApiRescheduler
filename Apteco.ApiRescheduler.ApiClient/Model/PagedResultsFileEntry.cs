...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsFileEntry :  IEquatable<PagedResultsFileEntry>
    {
        /// <summary>
        ...
        public PagedResultsFileEntry(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<FileEntry> _list = default(List<FileEntry>))
        {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsFileEntry and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<FileEntry> _List { get; set; }
