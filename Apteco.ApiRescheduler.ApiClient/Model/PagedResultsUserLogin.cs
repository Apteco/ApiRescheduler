...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsUserLogin :  IEquatable<PagedResultsUserLogin>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsUserLogin" /> class.
        /// </summary>
        ...
        public PagedResultsUserLogin(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<UserLogin> _list = default(List<UserLogin>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsUserLogin and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsUserLogin and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsUserLogin and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsUserLogin and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<UserLogin> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsUserLogin {\n");
        ...
        {
            return this.Equals(input as PagedResultsUserLogin);
        }

        /// <summary>
        /// Returns true if PagedResultsUserLogin instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsUserLogin to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsUserLogin input)
        {
            if (input == null)
                return false;
