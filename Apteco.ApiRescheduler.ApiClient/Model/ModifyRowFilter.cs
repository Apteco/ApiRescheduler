...
{
    /// <summary>
    /// Details used to modify row filters
    /// </summary>
    [DataContract]
        public partial class ModifyRowFilter :  IEquatable<ModifyRowFilter>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyRowFilter" /> class.
        /// </summary>
        /// <param name="rowFilter">rowFilter (required).</param>
        ...
        public ModifyRowFilter(RowFilter rowFilter = default(RowFilter), string id = default(string), ModificationTypeEnum modificationType = default(ModificationTypeEnum))
        {
            // to ensure "rowFilter" is required (not null)
            if (rowFilter == null)
            {
                throw new InvalidDataException("rowFilter is a required property for ModifyRowFilter and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("modificationType is a required property for ModifyRowFilter and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyRowFilter {\n");
        ...
        {
            return this.Equals(input as ModifyRowFilter);
        }

        /// <summary>
        /// Returns true if ModifyRowFilter instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyRowFilter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyRowFilter input)
        {
            if (input == null)
                return false;
