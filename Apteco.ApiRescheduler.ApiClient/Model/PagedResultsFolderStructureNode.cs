...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
        ...
        public partial class PagedResultsFolderStructureNode :  IEquatable<PagedResultsFolderStructureNode>
    {
        ...
        public PagedResultsFolderStructureNode(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<FolderStructureNode> _list = default(List<FolderStructureNode>))
        {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsFolderStructureNode and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<FolderStructureNode> _List { get; set; }
