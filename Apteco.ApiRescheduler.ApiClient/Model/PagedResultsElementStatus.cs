...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsElementStatus :  IEquatable<PagedResultsElementStatus>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsElementStatus" /> class.
        /// </summary>
        ...
        public PagedResultsElementStatus(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<ElementStatus> _list = default(List<ElementStatus>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsElementStatus and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsElementStatus and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsElementStatus and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsElementStatus and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ElementStatus> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsElementStatus {\n");
        ...
        {
            return this.Equals(input as PagedResultsElementStatus);
        }

        /// <summary>
        /// Returns true if PagedResultsElementStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsElementStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsElementStatus input)
        {
            if (input == null)
                return false;
