...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AudienceExportJobDetail :  IEquatable<AudienceExportJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceExportJobDetail" /> class.
        /// </summary>
        /// <param name="audienceExport">audienceExport.</param>
        ...
        public AudienceExportJobDetail(AudienceExportDetail audienceExport = default(AudienceExportDetail), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AudienceExportJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for AudienceExportJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets AudienceExport
        /// </summary>
        [DataMember(Name="audienceExport", EmitDefaultValue=false)]
        public AudienceExportDetail AudienceExport { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudienceExportJobDetail {\n");
            sb.Append("  AudienceExport: ").Append(AudienceExport).Append("\n");
        ...
        {
            return this.Equals(input as AudienceExportJobDetail);
        }

        /// <summary>
        /// Returns true if AudienceExportJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceExportJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceExportJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AudienceExport == input.AudienceExport ||
                    (this.AudienceExport != null &&
                    this.AudienceExport.Equals(input.AudienceExport))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AudienceExport != null)
                    hashCode = hashCode * 59 + this.AudienceExport.GetHashCode();
                if (this.Id != null)
