...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsGroupSummary :  IEquatable<PagedResultsGroupSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsGroupSummary" /> class.
        /// </summary>
        ...
        public PagedResultsGroupSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<GroupSummary> _list = default(List<GroupSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsGroupSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsGroupSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsGroupSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsGroupSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<GroupSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsGroupSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsGroupSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsGroupSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsGroupSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsGroupSummary input)
        {
            if (input == null)
                return false;
