...
{
    /// <summary>
    /// Summary information for a Ftp Channel&#x27;s FtpOutputSettings
    /// </summary>
    [DataContract]
        public partial class FtpOutputSettingsSummary :  IEquatable<FtpOutputSettingsSummary>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FtpOutputSettingsSummary" /> class.
        /// </summary>
        ...
        public FtpOutputSettingsSummary(string ftpUri = default(string), bool? addCommunicationKey = default(bool?), bool? overwrite = default(bool?), AllowTransactionalOutputEnum allowTransactionalOutput = default(AllowTransactionalOutputEnum), List<VariableDetails> additionalVariables = default(List<VariableDetails>), FileSettings fileSettings = default(FileSettings))
        {
            ...
            {
                throw new InvalidDataException("allowTransactionalOutput is a required property for FtpOutputSettingsSummary and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FtpOutputSettingsSummary {\n");
        ...
        {
            return this.Equals(input as FtpOutputSettingsSummary);
        }

        /// <summary>
        /// Returns true if FtpOutputSettingsSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of FtpOutputSettingsSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FtpOutputSettingsSummary input)
        {
            if (input == null)
                return false;
