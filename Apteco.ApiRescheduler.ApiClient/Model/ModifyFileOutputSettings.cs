...
{
    /// <summary>
    /// Details for a ModifyFileOutputSettings
    /// </summary>
    [DataContract]
        public partial class ModifyFileOutputSettings :  IEquatable<ModifyFileOutputSettings>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyFileOutputSettings" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyFileOutputSettings {\n");
        ...
        {
            return this.Equals(input as ModifyFileOutputSettings);
        }

        /// <summary>
        /// Returns true if ModifyFileOutputSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyFileOutputSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyFileOutputSettings input)
        {
            if (input == null)
                return false;
