...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AudienceCalculatePreviewJobDetail :  IEquatable<AudienceCalculatePreviewJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceCalculatePreviewJobDetail" /> class.
        /// </summary>
        /// <param name="audiencePreviewResult">audiencePreviewResult.</param>
        ...
        public AudienceCalculatePreviewJobDetail(AudiencePreviewResultDetail audiencePreviewResult = default(AudiencePreviewResultDetail), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AudienceCalculatePreviewJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for AudienceCalculatePreviewJobDetail and cannot be null");
            }
            else
            {
                this.IsComplete = isComplete;
            }
            this.AudiencePreviewResult = audiencePreviewResult;
        ...
        /// <summary>
        /// Gets or Sets AudiencePreviewResult
        /// </summary>
        [DataMember(Name="audiencePreviewResult", EmitDefaultValue=false)]
        public AudiencePreviewResultDetail AudiencePreviewResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudienceCalculatePreviewJobDetail {\n");
            sb.Append("  AudiencePreviewResult: ").Append(AudiencePreviewResult).Append("\n");
        ...
        {
            return this.Equals(input as AudienceCalculatePreviewJobDetail);
        }

        /// <summary>
        /// Returns true if AudienceCalculatePreviewJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceCalculatePreviewJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceCalculatePreviewJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AudiencePreviewResult == input.AudiencePreviewResult ||
                    (this.AudiencePreviewResult != null &&
                    this.AudiencePreviewResult.Equals(input.AudiencePreviewResult))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AudiencePreviewResult != null)
                    hashCode = hashCode * 59 + this.AudiencePreviewResult.GetHashCode();
                if (this.Id != null)
