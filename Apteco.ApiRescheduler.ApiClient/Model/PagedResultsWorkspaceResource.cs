...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsWorkspaceResource :  IEquatable<PagedResultsWorkspaceResource>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsWorkspaceResource" /> class.
        /// </summary>
        ...
        public PagedResultsWorkspaceResource(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<WorkspaceResource> _list = default(List<WorkspaceResource>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsWorkspaceResource and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsWorkspaceResource and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsWorkspaceResource and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsWorkspaceResource and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<WorkspaceResource> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsWorkspaceResource {\n");
        ...
        {
            return this.Equals(input as PagedResultsWorkspaceResource);
        }

        /// <summary>
        /// Returns true if PagedResultsWorkspaceResource instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsWorkspaceResource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsWorkspaceResource input)
        {
            if (input == null)
                return false;
