...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyItemsModifyUserAudience :  IEquatable<ModifyItemsModifyUserAudience>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyItemsModifyUserAudience" /> class.
        /// </summary>
        ...
        public ModifyItemsModifyUserAudience(bool? returnModifiedItem = default(bool?), List<ModifyUserAudience> _list = default(List<ModifyUserAudience>))
        {
            // to ensure "returnModifiedItem" is required (not null)
            if (returnModifiedItem == null)
            {
                throw new InvalidDataException("returnModifiedItem is a required property for ModifyItemsModifyUserAudience and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for ModifyItemsModifyUserAudience and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ModifyUserAudience> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyItemsModifyUserAudience {\n");
        ...
        {
            return this.Equals(input as ModifyItemsModifyUserAudience);
        }

        /// <summary>
        /// Returns true if ModifyItemsModifyUserAudience instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyItemsModifyUserAudience to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyItemsModifyUserAudience input)
        {
            if (input == null)
                return false;
