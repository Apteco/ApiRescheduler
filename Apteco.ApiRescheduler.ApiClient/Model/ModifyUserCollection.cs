...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyUserCollection :  IEquatable<ModifyUserCollection>
    {
        /// <summary>
        ...
        public ModifyUserCollection(ModifyUserCollectionDetail collection = default(ModifyUserCollectionDetail), string id = default(string), ModificationTypeEnum modificationType = default(ModificationTypeEnum))
        {
