...
{
    /// <summary>
    /// Details for a schedule based on months
    /// </summary>
    [DataContract]
        public partial class ScheduleInMonths :  IEquatable<ScheduleInMonths>
    {
        /// <summary>
        /// Defines DayInWeek
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleInMonths" /> class.
        /// </summary>
        ...
        /// </summary>
        [DataMember(Name="periodInMonths", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScheduleInMonths {\n");
        ...
        {
            return this.Equals(input as ScheduleInMonths);
        }

        /// <summary>
        /// Returns true if ScheduleInMonths instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleInMonths to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleInMonths input)
        {
            if (input == null)
                return false;
