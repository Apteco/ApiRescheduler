...
{
    /// <summary>
    /// Details used to modify a velocity band
    /// </summary>
    [DataContract]
        public partial class ModifyVelocityBandResults :  IEquatable<ModifyVelocityBandResults>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyVelocityBandResults" /> class.
        /// </summary>
        /// <param name="velocityBand">velocityBand.</param>
        ...
        public ModifyVelocityBandResults(VelocityBand velocityBand = default(VelocityBand), string id = default(string), bool? succeeded = default(bool?), string status = default(string), int? statusCode = default(int?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ModifyVelocityBandResults and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (succeeded == null)
            {
                throw new InvalidDataException("succeeded is a required property for ModifyVelocityBandResults and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ModifyVelocityBandResults and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for ModifyVelocityBandResults and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets VelocityBand
        /// </summary>
        [DataMember(Name="velocityBand", EmitDefaultValue=false)]
        public VelocityBand VelocityBand { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyVelocityBandResults {\n");
        ...
        {
            return this.Equals(input as ModifyVelocityBandResults);
        }

        /// <summary>
        /// Returns true if ModifyVelocityBandResults instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyVelocityBandResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyVelocityBandResults input)
        {
            if (input == null)
                return false;
