...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ElementCheckInOutJobDetail :  IEquatable<ElementCheckInOutJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ElementCheckInOutJobDetail" /> class.
        /// </summary>
        /// <param name="checkOutDetail">checkOutDetail.</param>
        ...
        public ElementCheckInOutJobDetail(CheckOutDetail checkOutDetail = default(CheckOutDetail), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ElementCheckInOutJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for ElementCheckInOutJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets CheckOutDetail
        /// </summary>
        [DataMember(Name="checkOutDetail", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ElementCheckInOutJobDetail {\n");
            sb.Append("  CheckOutDetail: ").Append(CheckOutDetail).Append("\n");
        ...
        {
            return this.Equals(input as ElementCheckInOutJobDetail);
        }

        /// <summary>
        /// Returns true if ElementCheckInOutJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ElementCheckInOutJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ElementCheckInOutJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.CheckOutDetail == input.CheckOutDetail ||
                    (this.CheckOutDetail != null &&
                    this.CheckOutDetail.Equals(input.CheckOutDetail))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.CheckOutDetail != null)
                    hashCode = hashCode * 59 + this.CheckOutDetail.GetHashCode();
                if (this.Id != null)
