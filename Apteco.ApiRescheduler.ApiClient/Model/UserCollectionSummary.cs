...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
        ...
        public partial class UserCollectionSummary :  IEquatable<UserCollectionSummary>
    {
        ...
        public UserCollectionSummary(string viewingUsername = default(string), StatusEnum status = default(StatusEnum), bool? sharedToMe = default(bool?), bool? sharedByMe = default(bool?), int? accessRights = default(int?), int? id = default(int?), string title = default(string), string description = default(string), DateTime? creationDate = default(DateTime?), UserDisplayDetails owner = default(UserDisplayDetails), DateTime? deletionDate = default(DateTime?), int? numberOfParts = default(int?), int? numberOfUsersSharedWith = default(int?), bool? sharedToAll = default(bool?), int? shareId = default(int?), int? numberOfHits = default(int?), string systemName = default(string))
        {
            ...
            if (sharedToAll == null)
            {
                throw new InvalidDataException("sharedToAll is a required property for UserCollectionSummary and cannot be null");
            }
            else
            {
