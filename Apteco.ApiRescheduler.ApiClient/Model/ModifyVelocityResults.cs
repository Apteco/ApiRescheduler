...
{
    /// <summary>
    /// Details used to modify a velocity
    /// </summary>
    [DataContract]
        public partial class ModifyVelocityResults :  IEquatable<ModifyVelocityResults>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyVelocityResults" /> class.
        /// </summary>
        ...
        public ModifyVelocityResults(Velocity velocity = default(Velocity), string id = default(string), bool? succeeded = default(bool?), string status = default(string), int? statusCode = default(int?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ModifyVelocityResults and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (succeeded == null)
            {
                throw new InvalidDataException("succeeded is a required property for ModifyVelocityResults and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ModifyVelocityResults and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for ModifyVelocityResults and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyVelocityResults {\n");
        ...
        {
            return this.Equals(input as ModifyVelocityResults);
        }

        /// <summary>
        /// Returns true if ModifyVelocityResults instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyVelocityResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyVelocityResults input)
        {
            if (input == null)
                return false;
