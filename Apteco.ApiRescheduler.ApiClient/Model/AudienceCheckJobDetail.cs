...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AudienceCheckJobDetail :  IEquatable<AudienceCheckJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceCheckJobDetail" /> class.
        /// </summary>
        /// <param name="audienceCheck">audienceCheck.</param>
        ...
        public AudienceCheckJobDetail(AudienceCheckDetail audienceCheck = default(AudienceCheckDetail), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AudienceCheckJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for AudienceCheckJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets AudienceCheck
        /// </summary>
        [DataMember(Name="audienceCheck", EmitDefaultValue=false)]
        public AudienceCheckDetail AudienceCheck { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudienceCheckJobDetail {\n");
            sb.Append("  AudienceCheck: ").Append(AudienceCheck).Append("\n");
        ...
        {
            return this.Equals(input as AudienceCheckJobDetail);
        }

        /// <summary>
        /// Returns true if AudienceCheckJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceCheckJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceCheckJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AudienceCheck == input.AudienceCheck ||
                    (this.AudienceCheck != null &&
                    this.AudienceCheck.Equals(input.AudienceCheck))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AudienceCheck != null)
                    hashCode = hashCode * 59 + this.AudienceCheck.GetHashCode();
                if (this.Id != null)
