...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsDataViewSummary :  IEquatable<PagedResultsDataViewSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsDataViewSummary" /> class.
        /// </summary>
        ...
        public PagedResultsDataViewSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<DataViewSummary> _list = default(List<DataViewSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsDataViewSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsDataViewSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsDataViewSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsDataViewSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<DataViewSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsDataViewSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsDataViewSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsDataViewSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsDataViewSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsDataViewSummary input)
        {
            if (input == null)
                return false;
