...
{
    /// <summary>
    /// Details for a job to delete a peoplestage elemtn
    /// </summary>
    [DataContract]
        public partial class DeleteElementJobDetail :  IEquatable<DeleteElementJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteElementJobDetail" /> class.
        /// </summary>
        ...
        public DeleteElementJobDetail(CampaignJourneySummary journeySummary = default(CampaignJourneySummary), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for DeleteElementJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for DeleteElementJobDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteElementJobDetail {\n");
        ...
        {
            return this.Equals(input as DeleteElementJobDetail);
        }

        /// <summary>
        /// Returns true if DeleteElementJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of DeleteElementJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeleteElementJobDetail input)
        {
            if (input == null)
                return false;
