...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
        ...
        public partial class PagedResultsFileSystemSummary :  IEquatable<PagedResultsFileSystemSummary>
    {
        ...
        public PagedResultsFileSystemSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<FileSystemSummary> _list = default(List<FileSystemSummary>))
        {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsFileSystemSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<FileSystemSummary> _List { get; set; }
