...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsUserSummary :  IEquatable<PagedResultsUserSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsUserSummary" /> class.
        /// </summary>
        ...
        public PagedResultsUserSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<UserSummary> _list = default(List<UserSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsUserSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsUserSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsUserSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsUserSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<UserSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsUserSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsUserSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsUserSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsUserSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsUserSummary input)
        {
            if (input == null)
                return false;
