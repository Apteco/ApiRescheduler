...
{
    /// <summary>
    /// Details for a job to retrieve the journey for a peoplestage campaign
    /// </summary>
    [DataContract]
        public partial class LoadCampaignJourneyJobDetail :  IEquatable<LoadCampaignJourneyJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoadCampaignJourneyJobDetail" /> class.
        /// </summary>
        ...
        public LoadCampaignJourneyJobDetail(CampaignJourneySummary journeySummary = default(CampaignJourneySummary), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for LoadCampaignJourneyJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for LoadCampaignJourneyJobDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LoadCampaignJourneyJobDetail {\n");
        ...
        {
            return this.Equals(input as LoadCampaignJourneyJobDetail);
        }

        /// <summary>
        /// Returns true if LoadCampaignJourneyJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of LoadCampaignJourneyJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoadCampaignJourneyJobDetail input)
        {
            if (input == null)
                return false;
