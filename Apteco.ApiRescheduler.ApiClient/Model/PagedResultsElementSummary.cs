...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsElementSummary :  IEquatable<PagedResultsElementSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsElementSummary" /> class.
        /// </summary>
        ...
        public PagedResultsElementSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<ElementSummary> _list = default(List<ElementSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsElementSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsElementSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsElementSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsElementSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ElementSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsElementSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsElementSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsElementSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsElementSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsElementSummary input)
        {
            if (input == null)
                return false;
