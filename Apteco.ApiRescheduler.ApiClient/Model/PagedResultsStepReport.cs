...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsStepReport :  IEquatable<PagedResultsStepReport>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsStepReport" /> class.
        /// </summary>
        ...
        public PagedResultsStepReport(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<StepReport> _list = default(List<StepReport>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsStepReport and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsStepReport and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsStepReport and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsStepReport and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<StepReport> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsStepReport {\n");
        ...
        {
            return this.Equals(input as PagedResultsStepReport);
        }

        /// <summary>
        /// Returns true if PagedResultsStepReport instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsStepReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsStepReport input)
        {
            if (input == null)
                return false;
