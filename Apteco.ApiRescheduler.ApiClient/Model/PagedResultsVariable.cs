...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsVariable :  IEquatable<PagedResultsVariable>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsVariable" /> class.
        /// </summary>
        ...
        public PagedResultsVariable(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<Variable> _list = default(List<Variable>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsVariable and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsVariable and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsVariable and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsVariable and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<Variable> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsVariable {\n");
        ...
        {
            return this.Equals(input as PagedResultsVariable);
        }

        /// <summary>
        /// Returns true if PagedResultsVariable instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsVariable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsVariable input)
        {
            if (input == null)
                return false;
