...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsLicensingSet :  IEquatable<PagedResultsLicensingSet>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsLicensingSet" /> class.
        /// </summary>
        ...
        public PagedResultsLicensingSet(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<LicensingSet> _list = default(List<LicensingSet>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsLicensingSet and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsLicensingSet and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsLicensingSet and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsLicensingSet and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<LicensingSet> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsLicensingSet {\n");
        ...
        {
            return this.Equals(input as PagedResultsLicensingSet);
        }

        /// <summary>
        /// Returns true if PagedResultsLicensingSet instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsLicensingSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsLicensingSet input)
        {
            if (input == null)
                return false;
