...
{
    /// <summary>
    /// Details for a job to retrieve the schedule for a peoplestage campaign
    /// </summary>
    [DataContract]
        public partial class LoadCampaignScheduleJobDetail :  IEquatable<LoadCampaignScheduleJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LoadCampaignScheduleJobDetail" /> class.
        /// </summary>
        ...
        public LoadCampaignScheduleJobDetail(CampaignScheduleSummary scheduleSummary = default(CampaignScheduleSummary), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for LoadCampaignScheduleJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for LoadCampaignScheduleJobDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LoadCampaignScheduleJobDetail {\n");
        ...
        {
            return this.Equals(input as LoadCampaignScheduleJobDetail);
        }

        /// <summary>
        /// Returns true if LoadCampaignScheduleJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of LoadCampaignScheduleJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LoadCampaignScheduleJobDetail input)
        {
            if (input == null)
                return false;
