...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateAudienceHitDetails :  IEquatable<CreateAudienceHitDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAudienceHitDetails" /> class.
        /// </summary>
        /// <param name="userAgentDetails">Details of the client application that made the view.</param>
        public CreateAudienceHitDetails(string userAgentDetails = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAudienceHitDetails {\n");
        ...
        {
            return this.Equals(input as CreateAudienceHitDetails);
        }

        /// <summary>
        /// Returns true if CreateAudienceHitDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateAudienceHitDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateAudienceHitDetails input)
        {
            if (input == null)
                return false;
