...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ElementPublishJobDetail :  IEquatable<ElementPublishJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ElementPublishJobDetail" /> class.
        /// </summary>
        ...
        public ElementPublishJobDetail(string elementId = default(string), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ElementPublishJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for ElementPublishJobDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ElementPublishJobDetail {\n");
        ...
        {
            return this.Equals(input as ElementPublishJobDetail);
        }

        /// <summary>
        /// Returns true if ElementPublishJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ElementPublishJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ElementPublishJobDetail input)
        {
            if (input == null)
                return false;
