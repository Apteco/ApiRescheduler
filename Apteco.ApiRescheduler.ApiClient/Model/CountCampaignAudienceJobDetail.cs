...
{
    /// <summary>
    /// Details for a job to count an audience in a peoplestage campaign
    /// </summary>
    [DataContract]
        public partial class CountCampaignAudienceJobDetail :  IEquatable<CountCampaignAudienceJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountCampaignAudienceJobDetail" /> class.
        /// </summary>
        /// <param name="journeyAudienceCounts">journeyAudienceCounts.</param>
        ...
        public CountCampaignAudienceJobDetail(JourneyAudienceCounts journeyAudienceCounts = default(JourneyAudienceCounts), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for CountCampaignAudienceJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for CountCampaignAudienceJobDetail and cannot be null");
            }
            else
            {
                this.IsComplete = isComplete;
            }
            this.JourneyAudienceCounts = journeyAudienceCounts;
        ...
        /// <summary>
        /// Gets or Sets JourneyAudienceCounts
        /// </summary>
        [DataMember(Name="journeyAudienceCounts", EmitDefaultValue=false)]
        public JourneyAudienceCounts JourneyAudienceCounts { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CountCampaignAudienceJobDetail {\n");
            sb.Append("  JourneyAudienceCounts: ").Append(JourneyAudienceCounts).Append("\n");
        ...
        {
            return this.Equals(input as CountCampaignAudienceJobDetail);
        }

        /// <summary>
        /// Returns true if CountCampaignAudienceJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of CountCampaignAudienceJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CountCampaignAudienceJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.JourneyAudienceCounts == input.JourneyAudienceCounts ||
                    (this.JourneyAudienceCounts != null &&
                    this.JourneyAudienceCounts.Equals(input.JourneyAudienceCounts))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.JourneyAudienceCounts != null)
                    hashCode = hashCode * 59 + this.JourneyAudienceCounts.GetHashCode();
                if (this.Id != null)
