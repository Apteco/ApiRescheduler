...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BuildJobDetail :  IEquatable<BuildJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BuildJobDetail" /> class.
        /// </summary>
        /// <param name="buildResult">buildResult.</param>
        ...
        public BuildJobDetail(BuildResult buildResult = default(BuildResult), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for BuildJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for BuildJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets BuildResult
        /// </summary>
        [DataMember(Name="buildResult", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BuildJobDetail {\n");
        ...
        {
            return this.Equals(input as BuildJobDetail);
        }

        /// <summary>
        /// Returns true if BuildJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of BuildJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuildJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.BuildResult == input.BuildResult ||
                    (this.BuildResult != null &&
                    this.BuildResult.Equals(input.BuildResult))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.BuildResult != null)
                    hashCode = hashCode * 59 + this.BuildResult.GetHashCode();
                if (this.Id != null)
