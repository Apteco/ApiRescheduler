...
{
    /// <summary>
    /// Details for a job to retrieve approvals for a peoplestage element
    /// </summary>
    [DataContract]
        public partial class GetApprovalsJobDetail :  IEquatable<GetApprovalsJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetApprovalsJobDetail" /> class.
        /// </summary>
        ...
        public GetApprovalsJobDetail(List<Approval> approvals = default(List<Approval>), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for GetApprovalsJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for GetApprovalsJobDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetApprovalsJobDetail {\n");
        ...
        {
            return this.Equals(input as GetApprovalsJobDetail);
        }

        /// <summary>
        /// Returns true if GetApprovalsJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of GetApprovalsJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetApprovalsJobDetail input)
        {
            if (input == null)
                return false;
