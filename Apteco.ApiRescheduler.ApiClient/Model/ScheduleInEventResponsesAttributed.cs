...
{
    /// <summary>
    /// Details for a response event schedule in a PeopleStage campaign
    /// </summary>
    [DataContract]
        public partial class ScheduleInEventResponsesAttributed :  IEquatable<ScheduleInEventResponsesAttributed>
    {
        /// <summary>
        /// Defines DelayUnits
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleInEventResponsesAttributed" /> class.
        /// </summary>
        ...
        public ScheduleInEventResponsesAttributed(int? delay = default(int?), DelayUnitsEnum? delayUnits = default(DelayUnitsEnum?), DateTimeAndZone start = default(DateTimeAndZone), DateTimeAndZone end = default(DateTimeAndZone), List<string> exclusionTimeWindows = default(List<string>), int? id = default(int?))
        {
            this.Delay = delay;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScheduleInEventResponsesAttributed {\n");
        ...
        {
            return this.Equals(input as ScheduleInEventResponsesAttributed);
        }

        /// <summary>
        /// Returns true if ScheduleInEventResponsesAttributed instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleInEventResponsesAttributed to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleInEventResponsesAttributed input)
        {
            if (input == null)
                return false;
