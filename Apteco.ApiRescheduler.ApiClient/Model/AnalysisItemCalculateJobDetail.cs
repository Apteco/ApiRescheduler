...
{
    /// <summary>
    /// Details for a job to calculate on an analysis item
    /// </summary>
    [DataContract]
        public partial class AnalysisItemCalculateJobDetail :  IEquatable<AnalysisItemCalculateJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnalysisItemCalculateJobDetail" /> class.
        /// </summary>
        /// <param name="analysisItemResult">analysisItemResult.</param>
        ...
        public AnalysisItemCalculateJobDetail(AbstractAnalysisItemResult analysisItemResult = default(AbstractAnalysisItemResult), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AnalysisItemCalculateJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for AnalysisItemCalculateJobDetail and cannot be null");
            }
            else
            {
                this.IsComplete = isComplete;
            }
            this.AnalysisItemResult = analysisItemResult;
        ...
        /// <summary>
        /// Gets or Sets AnalysisItemResult
        /// </summary>
        [DataMember(Name="analysisItemResult", EmitDefaultValue=false)]
        public AbstractAnalysisItemResult AnalysisItemResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnalysisItemCalculateJobDetail {\n");
            sb.Append("  AnalysisItemResult: ").Append(AnalysisItemResult).Append("\n");
        ...
        {
            return this.Equals(input as AnalysisItemCalculateJobDetail);
        }

        /// <summary>
        /// Returns true if AnalysisItemCalculateJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AnalysisItemCalculateJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnalysisItemCalculateJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AnalysisItemResult == input.AnalysisItemResult ||
                    (this.AnalysisItemResult != null &&
                    this.AnalysisItemResult.Equals(input.AnalysisItemResult))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AnalysisItemResult != null)
                    hashCode = hashCode * 59 + this.AnalysisItemResult.GetHashCode();
                if (this.Id != null)
