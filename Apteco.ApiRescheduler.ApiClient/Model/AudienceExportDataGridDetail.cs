...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AudienceExportDataGridDetail :  IEquatable<AudienceExportDataGridDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceExportDataGridDetail" /> class.
        /// </summary>
        ...
        public AudienceExportDataGridDetail(int? audienceUpdateId = default(int?), DateTime? timestamp = default(DateTime?), DateTime? fastStatsBuildDate = default(DateTime?), UserDisplayDetails user = default(UserDisplayDetails), List<Count> nettCounts = default(List<Count>), string urnFilePath = default(string), LimitsInformation limitsInformation = default(LimitsInformation), bool? returnBrowseRows = default(bool?), string filePath = default(string), Output output = default(Output), List<AnalysisColumn> columns = default(List<AnalysisColumn>), List<Row> rows = default(List<Row>), SystemLookup systemLookup = default(SystemLookup))
        {
            // to ensure "audienceUpdateId" is required (not null)
            if (audienceUpdateId == null)
            {
                throw new InvalidDataException("audienceUpdateId is a required property for AudienceExportDataGridDetail and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for AudienceExportDataGridDetail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("fastStatsBuildDate is a required property for AudienceExportDataGridDetail and cannot be null");
            }
            else
            {
            ...
            if (user == null)
            {
                throw new InvalidDataException("user is a required property for AudienceExportDataGridDetail and cannot be null");
            }
            else
            {
                this.User = user;
            ...
            if (nettCounts == null)
            {
                throw new InvalidDataException("nettCounts is a required property for AudienceExportDataGridDetail and cannot be null");
            }
            else
            {
            ...
            if (urnFilePath == null)
            {
                throw new InvalidDataException("urnFilePath is a required property for AudienceExportDataGridDetail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("limitsInformation is a required property for AudienceExportDataGridDetail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("returnBrowseRows is a required property for AudienceExportDataGridDetail and cannot be null");
            }
            else
            {
            ...
            if (columns == null)
            {
                throw new InvalidDataException("columns is a required property for AudienceExportDataGridDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudienceExportDataGridDetail {\n");
        ...
        {
            return this.Equals(input as AudienceExportDataGridDetail);
        }

        /// <summary>
        /// Returns true if AudienceExportDataGridDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceExportDataGridDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceExportDataGridDetail input)
        {
            if (input == null)
                return false;
