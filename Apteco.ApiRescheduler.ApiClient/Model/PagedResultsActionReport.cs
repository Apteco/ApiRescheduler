...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsActionReport :  IEquatable<PagedResultsActionReport>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsActionReport" /> class.
        /// </summary>
        ...
        public PagedResultsActionReport(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<ActionReport> _list = default(List<ActionReport>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsActionReport and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsActionReport and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsActionReport and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsActionReport and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ActionReport> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsActionReport {\n");
        ...
        {
            return this.Equals(input as PagedResultsActionReport);
        }

        /// <summary>
        /// Returns true if PagedResultsActionReport instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsActionReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsActionReport input)
        {
            if (input == null)
                return false;
