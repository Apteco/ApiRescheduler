...
{
    /// <summary>
    /// Details used to modify ftp sites
    /// </summary>
    [DataContract]
        public partial class ModifyFtpSite :  IEquatable<ModifyFtpSite>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyFtpSite" /> class.
        /// </summary>
        /// <param name="ftpSite">ftpSite (required).</param>
        ...
        public ModifyFtpSite(FtpSite ftpSite = default(FtpSite), string id = default(string), ModificationTypeEnum modificationType = default(ModificationTypeEnum))
        {
            // to ensure "ftpSite" is required (not null)
            if (ftpSite == null)
            {
                throw new InvalidDataException("ftpSite is a required property for ModifyFtpSite and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("modificationType is a required property for ModifyFtpSite and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as ModifyFtpSite);
        }

        /// <summary>
        /// Returns true if ModifyFtpSite instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyFtpSite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyFtpSite input)
        {
            if (input == null)
                return false;
