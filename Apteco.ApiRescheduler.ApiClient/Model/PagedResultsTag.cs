...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsTag :  IEquatable<PagedResultsTag>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsTag" /> class.
        /// </summary>
        ...
        public PagedResultsTag(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<Tag> _list = default(List<Tag>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsTag and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsTag and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsTag and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsTag and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsTag {\n");
        ...
        {
            return this.Equals(input as PagedResultsTag);
        }

        /// <summary>
        /// Returns true if PagedResultsTag instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsTag to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsTag input)
        {
            if (input == null)
                return false;
