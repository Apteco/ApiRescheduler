...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AudienceHitDetail :  IEquatable<AudienceHitDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceHitDetail" /> class.
        /// </summary>
        ...
        public AudienceHitDetail(string userAgentDetails = default(string), int? id = default(int?), int? audienceId = default(int?), DateTime? timestamp = default(DateTime?), UserDisplayDetails user = default(UserDisplayDetails))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AudienceHitDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (audienceId == null)
            {
                throw new InvalidDataException("audienceId is a required property for AudienceHitDetail and cannot be null");
            }
            else
            {
            ...
            if (timestamp == null)
            {
                throw new InvalidDataException("timestamp is a required property for AudienceHitDetail and cannot be null");
            }
            else
            {
            ...
            if (user == null)
            {
                throw new InvalidDataException("user is a required property for AudienceHitDetail and cannot be null");
            }
            else
            {
                this.User = user;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudienceHitDetail {\n");
        ...
        {
            return this.Equals(input as AudienceHitDetail);
        }

        /// <summary>
        /// Returns true if AudienceHitDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceHitDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceHitDetail input)
        {
            if (input == null)
                return false;
