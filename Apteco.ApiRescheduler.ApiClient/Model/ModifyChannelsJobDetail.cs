...
{
    /// <summary>
    /// Details for a job to publish a peoplestage element
    /// </summary>
    [DataContract]
        public partial class ModifyChannelsJobDetail :  IEquatable<ModifyChannelsJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyChannelsJobDetail" /> class.
        /// </summary>
        /// <param name="modifyResults">modifyResults.</param>
        ...
        public ModifyChannelsJobDetail(PagedResultsModifyChannelDetailResults modifyResults = default(PagedResultsModifyChannelDetailResults), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ModifyChannelsJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for ModifyChannelsJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets ModifyResults
        /// </summary>
        [DataMember(Name="modifyResults", EmitDefaultValue=false)]
        public PagedResultsModifyChannelDetailResults ModifyResults { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyChannelsJobDetail {\n");
            sb.Append("  ModifyResults: ").Append(ModifyResults).Append("\n");
        ...
        {
            return this.Equals(input as ModifyChannelsJobDetail);
        }

        /// <summary>
        /// Returns true if ModifyChannelsJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyChannelsJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyChannelsJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ModifyResults == input.ModifyResults ||
                    (this.ModifyResults != null &&
                    this.ModifyResults.Equals(input.ModifyResults))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ModifyResults != null)
                    hashCode = hashCode * 59 + this.ModifyResults.GetHashCode();
                if (this.Id != null)
