...
{
    /// <summary>
    /// Permission details for a group
    /// </summary>
    [DataContract]
        public partial class GroupPermissionDetails :  IEquatable<GroupPermissionDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupPermissionDetails" /> class.
        /// </summary>
        /// <param name="accessRights">The access rights for the given group (required).</param>
        ...
        public GroupPermissionDetails(int? accessRights = default(int?), int? id = default(int?), string name = default(string), List<string> systems = default(List<string>), List<UserSummary> userMembership = default(List<UserSummary>), int? userMembershipCount = default(int?), bool? systemMembership = default(bool?))
        {
            // to ensure "accessRights" is required (not null)
            if (accessRights == null)
            {
                throw new InvalidDataException("accessRights is a required property for GroupPermissionDetails and cannot be null");
            }
            else
            {
            ...
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for GroupPermissionDetails and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for GroupPermissionDetails and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (systems == null)
            {
                throw new InvalidDataException("systems is a required property for GroupPermissionDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("userMembership is a required property for GroupPermissionDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("userMembershipCount is a required property for GroupPermissionDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("systemMembership is a required property for GroupPermissionDetails and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// The access rights for the given group
        /// </summary>
        /// <value>The access rights for the given group</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupPermissionDetails {\n");
        ...
        {
            return this.Equals(input as GroupPermissionDetails);
        }

        /// <summary>
        /// Returns true if GroupPermissionDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupPermissionDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupPermissionDetails input)
        {
            if (input == null)
                return false;
