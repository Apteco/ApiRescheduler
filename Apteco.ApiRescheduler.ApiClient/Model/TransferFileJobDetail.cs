...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TransferFileJobDetail :  IEquatable<TransferFileJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransferFileJobDetail" /> class.
        /// </summary>
        /// <param name="temporaryFilePath">The path of the file created in temporary files.</param>
        ...
        public TransferFileJobDetail(string temporaryFilePath = default(string), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for TransferFileJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for TransferFileJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// The path of the file created in temporary files
        /// </summary>
        /// <value>The path of the file created in temporary files</value>
        [DataMember(Name="temporaryFilePath", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransferFileJobDetail {\n");
        ...
        {
            return this.Equals(input as TransferFileJobDetail);
        }

        /// <summary>
        /// Returns true if TransferFileJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of TransferFileJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransferFileJobDetail input)
        {
            if (input == null)
                return false;
