...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyItemsModifyUserWorkspace :  IEquatable<ModifyItemsModifyUserWorkspace>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyItemsModifyUserWorkspace" /> class.
        /// </summary>
        ...
        public ModifyItemsModifyUserWorkspace(bool? returnModifiedItem = default(bool?), List<ModifyUserWorkspace> _list = default(List<ModifyUserWorkspace>))
        {
            // to ensure "returnModifiedItem" is required (not null)
            if (returnModifiedItem == null)
            {
                throw new InvalidDataException("returnModifiedItem is a required property for ModifyItemsModifyUserWorkspace and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for ModifyItemsModifyUserWorkspace and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ModifyUserWorkspace> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyItemsModifyUserWorkspace {\n");
        ...
        {
            return this.Equals(input as ModifyItemsModifyUserWorkspace);
        }

        /// <summary>
        /// Returns true if ModifyItemsModifyUserWorkspace instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyItemsModifyUserWorkspace to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyItemsModifyUserWorkspace input)
        {
            if (input == null)
                return false;
