...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FastStatsLogsPackageJobDetail :  IEquatable<FastStatsLogsPackageJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FastStatsLogsPackageJobDetail" /> class.
        /// </summary>
        /// <param name="serviceLogPackage">serviceLogPackage (required).</param>
        ...
        public FastStatsLogsPackageJobDetail(ServiceLogPackage serviceLogPackage = default(ServiceLogPackage), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "serviceLogPackage" is required (not null)
            if (serviceLogPackage == null)
            {
                throw new InvalidDataException("serviceLogPackage is a required property for FastStatsLogsPackageJobDetail and cannot be null");
            }
            else
            {
                this.ServiceLogPackage = serviceLogPackage;
            }
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for FastStatsLogsPackageJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for FastStatsLogsPackageJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets ServiceLogPackage
        /// </summary>
        [DataMember(Name="serviceLogPackage", EmitDefaultValue=false)]
        public ServiceLogPackage ServiceLogPackage { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FastStatsLogsPackageJobDetail {\n");
            sb.Append("  ServiceLogPackage: ").Append(ServiceLogPackage).Append("\n");
        ...
        {
            return this.Equals(input as FastStatsLogsPackageJobDetail);
        }

        /// <summary>
        /// Returns true if FastStatsLogsPackageJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of FastStatsLogsPackageJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FastStatsLogsPackageJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ServiceLogPackage == input.ServiceLogPackage ||
                    (this.ServiceLogPackage != null &&
                    this.ServiceLogPackage.Equals(input.ServiceLogPackage))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ServiceLogPackage != null)
                    hashCode = hashCode * 59 + this.ServiceLogPackage.GetHashCode();
                if (this.Id != null)
