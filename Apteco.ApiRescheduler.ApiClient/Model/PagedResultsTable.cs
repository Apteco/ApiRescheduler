...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsTable :  IEquatable<PagedResultsTable>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsTable" /> class.
        /// </summary>
        ...
        public PagedResultsTable(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<Table> _list = default(List<Table>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsTable and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsTable and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsTable and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsTable and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<Table> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsTable {\n");
        ...
        {
            return this.Equals(input as PagedResultsTable);
        }

        /// <summary>
        /// Returns true if PagedResultsTable instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsTable to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsTable input)
        {
            if (input == null)
                return false;
