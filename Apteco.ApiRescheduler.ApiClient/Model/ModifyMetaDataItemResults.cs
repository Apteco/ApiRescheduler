...
{
    /// <summary>
    /// Details used to modify a meta data item
    /// </summary>
    [DataContract]
        public partial class ModifyMetaDataItemResults :  IEquatable<ModifyMetaDataItemResults>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyMetaDataItemResults" /> class.
        /// </summary>
        /// <param name="metaDataItem">metaDataItem.</param>
        ...
        public ModifyMetaDataItemResults(MetaDataItem metaDataItem = default(MetaDataItem), string id = default(string), bool? succeeded = default(bool?), string status = default(string), int? statusCode = default(int?))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ModifyMetaDataItemResults and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (succeeded == null)
            {
                throw new InvalidDataException("succeeded is a required property for ModifyMetaDataItemResults and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for ModifyMetaDataItemResults and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (statusCode == null)
            {
                throw new InvalidDataException("statusCode is a required property for ModifyMetaDataItemResults and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyMetaDataItemResults {\n");
        ...
        {
            return this.Equals(input as ModifyMetaDataItemResults);
        }

        /// <summary>
        /// Returns true if ModifyMetaDataItemResults instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyMetaDataItemResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyMetaDataItemResults input)
        {
            if (input == null)
                return false;
