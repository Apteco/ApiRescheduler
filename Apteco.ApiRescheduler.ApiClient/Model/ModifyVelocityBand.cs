...
{
    /// <summary>
    /// Details used to modify velocity bands
    /// </summary>
    [DataContract]
        public partial class ModifyVelocityBand :  IEquatable<ModifyVelocityBand>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyVelocityBand" /> class.
        /// </summary>
        /// <param name="velocityBand">velocityBand (required).</param>
        ...
        public ModifyVelocityBand(VelocityBand velocityBand = default(VelocityBand), string id = default(string), ModificationTypeEnum modificationType = default(ModificationTypeEnum))
        {
            // to ensure "velocityBand" is required (not null)
            if (velocityBand == null)
            {
                throw new InvalidDataException("velocityBand is a required property for ModifyVelocityBand and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("modificationType is a required property for ModifyVelocityBand and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyVelocityBand {\n");
        ...
        {
            return this.Equals(input as ModifyVelocityBand);
        }

        /// <summary>
        /// Returns true if ModifyVelocityBand instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyVelocityBand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyVelocityBand input)
        {
            if (input == null)
                return false;
