...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyUserDashboardDetail :  IEquatable<ModifyUserDashboardDetail>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyUserDashboardDetail" /> class.
        /// </summary>
        /// <param name="status">The status of the dashboard.</param>
        ...
        public ModifyUserDashboardDetail(StatusEnum? status = default(StatusEnum?), int? id = default(int?), string title = default(string), string description = default(string), int? themeId = default(int?), int? logoId = default(int?), Query baseQuery = default(Query), FilterDefinition predefinedUserFilters = default(FilterDefinition), List<DashboardContentItem> dashboardItems = default(List<DashboardContentItem>), string systemName = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ModifyUserDashboardDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (title == null)
            {
                throw new InvalidDataException("title is a required property for ModifyUserDashboardDetail and cannot be null");
            }
            else
            {
                this.Title = title;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyUserDashboardDetail {\n");
        ...
        {
            return this.Equals(input as ModifyUserDashboardDetail);
        }

        /// <summary>
        /// Returns true if ModifyUserDashboardDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyUserDashboardDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyUserDashboardDetail input)
        {
            if (input == null)
                return false;
