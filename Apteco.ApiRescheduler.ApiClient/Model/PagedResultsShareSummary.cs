...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsShareSummary :  IEquatable<PagedResultsShareSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsShareSummary" /> class.
        /// </summary>
        ...
        public PagedResultsShareSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<ShareSummary> _list = default(List<ShareSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsShareSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsShareSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsShareSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsShareSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ShareSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsShareSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsShareSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsShareSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsShareSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsShareSummary input)
        {
            if (input == null)
                return false;
