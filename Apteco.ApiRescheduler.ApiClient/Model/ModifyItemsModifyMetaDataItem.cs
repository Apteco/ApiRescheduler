...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyItemsModifyMetaDataItem :  IEquatable<ModifyItemsModifyMetaDataItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyItemsModifyMetaDataItem" /> class.
        /// </summary>
        ...
        public ModifyItemsModifyMetaDataItem(bool? returnModifiedItem = default(bool?), List<ModifyMetaDataItem> _list = default(List<ModifyMetaDataItem>))
        {
            // to ensure "returnModifiedItem" is required (not null)
            if (returnModifiedItem == null)
            {
                throw new InvalidDataException("returnModifiedItem is a required property for ModifyItemsModifyMetaDataItem and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for ModifyItemsModifyMetaDataItem and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ModifyMetaDataItem> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyItemsModifyMetaDataItem {\n");
        ...
        {
            return this.Equals(input as ModifyItemsModifyMetaDataItem);
        }

        /// <summary>
        /// Returns true if ModifyItemsModifyMetaDataItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyItemsModifyMetaDataItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyItemsModifyMetaDataItem input)
        {
            if (input == null)
                return false;
