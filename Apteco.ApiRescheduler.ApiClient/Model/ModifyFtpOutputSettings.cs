...
{
    /// <summary>
    /// Details for a ModifyFtpOutputSettings
    /// </summary>
    [DataContract]
        public partial class ModifyFtpOutputSettings :  IEquatable<ModifyFtpOutputSettings>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyFtpOutputSettings" /> class.
        /// </summary>
        ...
        public ModifyFtpOutputSettings(string password = default(string), string username = default(string), string privateKeyPath = default(string), bool? addAdditionalVariablesDirectly = default(bool?), DirectAdditionalVariablesLocationEnum? directAdditionalVariablesLocation = default(DirectAdditionalVariablesLocationEnum?), int? initialResponseImpact = default(int?), string ftpUri = default(string), bool? addCommunicationKey = default(bool?), bool? overwrite = default(bool?), AllowTransactionalOutputEnum allowTransactionalOutput = default(AllowTransactionalOutputEnum), List<VariableDetails> additionalVariables = default(List<VariableDetails>), FileSettings fileSettings = default(FileSettings))
        {
            ...
            {
                throw new InvalidDataException("allowTransactionalOutput is a required property for ModifyFtpOutputSettings and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyFtpOutputSettings {\n");
        ...
        {
            return this.Equals(input as ModifyFtpOutputSettings);
        }

        /// <summary>
        /// Returns true if ModifyFtpOutputSettings instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyFtpOutputSettings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyFtpOutputSettings input)
        {
            if (input == null)
                return false;
