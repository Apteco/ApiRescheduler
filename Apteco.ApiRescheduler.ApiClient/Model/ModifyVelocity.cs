...
{
    /// <summary>
    /// Details used to modify velocities
    /// </summary>
    [DataContract]
        public partial class ModifyVelocity :  IEquatable<ModifyVelocity>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyVelocity" /> class.
        /// </summary>
        ...
        public ModifyVelocity(Velocity velocity = default(Velocity), string id = default(string), ModificationTypeEnum modificationType = default(ModificationTypeEnum))
        {
            // to ensure "velocity" is required (not null)
            if (velocity == null)
            {
                throw new InvalidDataException("velocity is a required property for ModifyVelocity and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("modificationType is a required property for ModifyVelocity and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyVelocity {\n");
        ...
        {
            return this.Equals(input as ModifyVelocity);
        }

        /// <summary>
        /// Returns true if ModifyVelocity instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyVelocity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyVelocity input)
        {
            if (input == null)
                return false;
