...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LastUsedExportTemplateDetail :  IEquatable<LastUsedExportTemplateDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LastUsedExportTemplateDetail" /> class.
        /// </summary>
        /// <param name="id">The id for this export template.</param>
        ...
        public LastUsedExportTemplateDetail(int? id = default(int?), string title = default(string), ExportTemplateDefinition exportTemplateDefinition = default(ExportTemplateDefinition), SystemLookup exportTemplateLookup = default(SystemLookup))
        {
            // to ensure "exportTemplateDefinition" is required (not null)
            if (exportTemplateDefinition == null)
            {
                throw new InvalidDataException("exportTemplateDefinition is a required property for LastUsedExportTemplateDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// The id for this export template
        /// </summary>
        /// <value>The id for this export template</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LastUsedExportTemplateDetail {\n");
        ...
        {
            return this.Equals(input as LastUsedExportTemplateDetail);
        }

        /// <summary>
        /// Returns true if LastUsedExportTemplateDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of LastUsedExportTemplateDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LastUsedExportTemplateDetail input)
        {
            if (input == null)
                return false;
