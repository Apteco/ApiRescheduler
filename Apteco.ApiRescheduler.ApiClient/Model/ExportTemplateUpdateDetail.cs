...
{
    /// <summary>
    /// Details for the definition of a template to update
    /// </summary>
    [DataContract]
        public partial class ExportTemplateUpdateDetail :  IEquatable<ExportTemplateUpdateDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportTemplateUpdateDetail" /> class.
        /// </summary>
        ...
        public ExportTemplateUpdateDetail(int? id = default(int?), string title = default(string), ExportTemplateDefinition exportTemplateDefinition = default(ExportTemplateDefinition), SystemLookup exportTemplateLookup = default(SystemLookup))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ExportTemplateUpdateDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            {
                throw new InvalidDataException("exportTemplateDefinition is a required property for ExportTemplateUpdateDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportTemplateUpdateDetail {\n");
        ...
        {
            return this.Equals(input as ExportTemplateUpdateDetail);
        }

        /// <summary>
        /// Returns true if ExportTemplateUpdateDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportTemplateUpdateDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportTemplateUpdateDetail input)
        {
            if (input == null)
                return false;
