...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsResourceSummary :  IEquatable<PagedResultsResourceSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsResourceSummary" /> class.
        /// </summary>
        ...
        public PagedResultsResourceSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<ResourceSummary> _list = default(List<ResourceSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsResourceSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsResourceSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsResourceSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsResourceSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ResourceSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsResourceSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsResourceSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsResourceSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsResourceSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsResourceSummary input)
        {
            if (input == null)
                return false;
