...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyItemsModifyVelocityBand :  IEquatable<ModifyItemsModifyVelocityBand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyItemsModifyVelocityBand" /> class.
        /// </summary>
        ...
        public ModifyItemsModifyVelocityBand(bool? returnModifiedItem = default(bool?), List<ModifyVelocityBand> _list = default(List<ModifyVelocityBand>))
        {
            // to ensure "returnModifiedItem" is required (not null)
            if (returnModifiedItem == null)
            {
                throw new InvalidDataException("returnModifiedItem is a required property for ModifyItemsModifyVelocityBand and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for ModifyItemsModifyVelocityBand and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ModifyVelocityBand> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyItemsModifyVelocityBand {\n");
        ...
        {
            return this.Equals(input as ModifyItemsModifyVelocityBand);
        }

        /// <summary>
        /// Returns true if ModifyItemsModifyVelocityBand instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyItemsModifyVelocityBand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyItemsModifyVelocityBand input)
        {
            if (input == null)
                return false;
