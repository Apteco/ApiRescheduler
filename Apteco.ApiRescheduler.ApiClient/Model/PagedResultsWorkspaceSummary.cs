...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsWorkspaceSummary :  IEquatable<PagedResultsWorkspaceSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsWorkspaceSummary" /> class.
        /// </summary>
        ...
        public PagedResultsWorkspaceSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<WorkspaceSummary> _list = default(List<WorkspaceSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsWorkspaceSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsWorkspaceSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsWorkspaceSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsWorkspaceSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<WorkspaceSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsWorkspaceSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsWorkspaceSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsWorkspaceSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsWorkspaceSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsWorkspaceSummary input)
        {
            if (input == null)
                return false;
