...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsAudienceSummary :  IEquatable<PagedResultsAudienceSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsAudienceSummary" /> class.
        /// </summary>
        ...
        public PagedResultsAudienceSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<AudienceSummary> _list = default(List<AudienceSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsAudienceSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsAudienceSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsAudienceSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsAudienceSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<AudienceSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsAudienceSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsAudienceSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsAudienceSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsAudienceSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsAudienceSummary input)
        {
            if (input == null)
                return false;
