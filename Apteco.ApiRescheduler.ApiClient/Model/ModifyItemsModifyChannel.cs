...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
        ...
        public partial class ModifyItemsModifyChannel :  IEquatable<ModifyItemsModifyChannel>
    {
        ...
        public ModifyItemsModifyChannel(bool? returnModifiedItem = default(bool?), List<ModifyChannel> _list = default(List<ModifyChannel>))
        {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for ModifyItemsModifyChannel and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ModifyChannel> _List { get; set; }
