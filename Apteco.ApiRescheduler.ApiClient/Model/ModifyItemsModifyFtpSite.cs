...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyItemsModifyFtpSite :  IEquatable<ModifyItemsModifyFtpSite>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyItemsModifyFtpSite" /> class.
        /// </summary>
        ...
        public ModifyItemsModifyFtpSite(bool? returnModifiedItem = default(bool?), List<ModifyFtpSite> _list = default(List<ModifyFtpSite>))
        {
            // to ensure "returnModifiedItem" is required (not null)
            if (returnModifiedItem == null)
            {
                throw new InvalidDataException("returnModifiedItem is a required property for ModifyItemsModifyFtpSite and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for ModifyItemsModifyFtpSite and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ModifyFtpSite> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyItemsModifyFtpSite {\n");
        ...
        {
            return this.Equals(input as ModifyItemsModifyFtpSite);
        }

        /// <summary>
        /// Returns true if ModifyItemsModifyFtpSite instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyItemsModifyFtpSite to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyItemsModifyFtpSite input)
        {
            if (input == null)
                return false;
