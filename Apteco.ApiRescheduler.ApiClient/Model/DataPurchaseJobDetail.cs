...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DataPurchaseJobDetail :  IEquatable<DataPurchaseJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DataPurchaseJobDetail" /> class.
        /// </summary>
        ...
        public DataPurchaseJobDetail(PurchaseInfo purchaseInfo = default(PurchaseInfo), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for DataPurchaseJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for DataPurchaseJobDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DataPurchaseJobDetail {\n");
        ...
        {
            return this.Equals(input as DataPurchaseJobDetail);
        }

        /// <summary>
        /// Returns true if DataPurchaseJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of DataPurchaseJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DataPurchaseJobDetail input)
        {
            if (input == null)
                return false;
