...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
        ...
        public partial class ModelParameter :  IEquatable<ModelParameter>
    {
        ...
        public ModelParameter(string key = default(string), string value = default(string))
        {
            this.Key = key;
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as ModelParameter);
        }

        /// <summary>
        /// Returns true if ModelParameter instances are equal
        /// </summary>
        /// <param name="input">Instance of ModelParameter to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelParameter input)
        {
            if (input == null)
                return false;
