...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AudienceDataLicensingInfoJobDetail :  IEquatable<AudienceDataLicensingInfoJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceDataLicensingInfoJobDetail" /> class.
        /// </summary>
        /// <param name="licensingInfo">licensingInfo.</param>
        ...
        public AudienceDataLicensingInfoJobDetail(LicensingInfo licensingInfo = default(LicensingInfo), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AudienceDataLicensingInfoJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for AudienceDataLicensingInfoJobDetail and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        [DataMember(Name="licensingInfo", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudienceDataLicensingInfoJobDetail {\n");
            sb.Append("  LicensingInfo: ").Append(LicensingInfo).Append("\n");
        ...
        {
            return this.Equals(input as AudienceDataLicensingInfoJobDetail);
        }

        /// <summary>
        /// Returns true if AudienceDataLicensingInfoJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceDataLicensingInfoJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceDataLicensingInfoJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.LicensingInfo == input.LicensingInfo ||
                    (this.LicensingInfo != null &&
                    this.LicensingInfo.Equals(input.LicensingInfo))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.LicensingInfo != null)
                    hashCode = hashCode * 59 + this.LicensingInfo.GetHashCode();
                if (this.Id != null)
