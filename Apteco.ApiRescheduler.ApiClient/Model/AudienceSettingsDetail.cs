...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AudienceSettingsDetail :  IEquatable<AudienceSettingsDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceSettingsDetail" /> class.
        /// </summary>
        ...
        public AudienceSettingsDetail(string systemName = default(string), bool? allowAudienceBrowserDownloadDeliveryEntry = default(bool?), bool? allowAudienceFtpDeliveryEntry = default(bool?))
        {
            // to ensure "systemName" is required (not null)
            if (systemName == null)
            {
                throw new InvalidDataException("systemName is a required property for AudienceSettingsDetail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("allowAudienceBrowserDownloadDeliveryEntry is a required property for AudienceSettingsDetail and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("allowAudienceFtpDeliveryEntry is a required property for AudienceSettingsDetail and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudienceSettingsDetail {\n");
        ...
        {
            return this.Equals(input as AudienceSettingsDetail);
        }

        /// <summary>
        /// Returns true if AudienceSettingsDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceSettingsDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceSettingsDetail input)
        {
            if (input == null)
                return false;
