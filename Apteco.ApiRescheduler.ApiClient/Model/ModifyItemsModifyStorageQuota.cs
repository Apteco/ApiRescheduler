...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyItemsModifyStorageQuota :  IEquatable<ModifyItemsModifyStorageQuota>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyItemsModifyStorageQuota" /> class.
        /// </summary>
        ...
        public ModifyItemsModifyStorageQuota(bool? returnModifiedItem = default(bool?), List<ModifyStorageQuota> _list = default(List<ModifyStorageQuota>))
        {
            // to ensure "returnModifiedItem" is required (not null)
            if (returnModifiedItem == null)
            {
                throw new InvalidDataException("returnModifiedItem is a required property for ModifyItemsModifyStorageQuota and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for ModifyItemsModifyStorageQuota and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ModifyStorageQuota> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyItemsModifyStorageQuota {\n");
        ...
        {
            return this.Equals(input as ModifyItemsModifyStorageQuota);
        }

        /// <summary>
        /// Returns true if ModifyItemsModifyStorageQuota instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyItemsModifyStorageQuota to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyItemsModifyStorageQuota input)
        {
            if (input == null)
                return false;
