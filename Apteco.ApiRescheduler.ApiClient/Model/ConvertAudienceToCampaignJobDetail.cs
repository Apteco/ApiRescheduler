...
{
    /// <summary>
    /// Details for a job to convert an audience to a PeopleStage campaign
    /// </summary>
    [DataContract]
        public partial class ConvertAudienceToCampaignJobDetail :  IEquatable<ConvertAudienceToCampaignJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertAudienceToCampaignJobDetail" /> class.
        /// </summary>
        /// <param name="campaignId">The generated campaign id.</param>
        /// <param name="areaIds">Any generated areas ids.</param>
        ...
        public ConvertAudienceToCampaignJobDetail(string campaignId = default(string), List<string> areaIds = default(List<string>), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ConvertAudienceToCampaignJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for ConvertAudienceToCampaignJobDetail and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The generated campaign id</value>
        [DataMember(Name="campaignId", EmitDefaultValue=false)]
        public string CampaignId { get; set; }

        /// <summary>
        /// Any generated areas ids
        /// </summary>
        /// <value>Any generated areas ids</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConvertAudienceToCampaignJobDetail {\n");
        ...
        {
            return this.Equals(input as ConvertAudienceToCampaignJobDetail);
        }

        /// <summary>
        /// Returns true if ConvertAudienceToCampaignJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ConvertAudienceToCampaignJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConvertAudienceToCampaignJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.AreaIds == input.AreaIds ||
                    this.AreaIds != null &&
                    input.AreaIds != null &&
                    this.AreaIds.SequenceEqual(input.AreaIds)
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AreaIds != null)
                    hashCode = hashCode * 59 + this.AreaIds.GetHashCode();
                if (this.Id != null)
