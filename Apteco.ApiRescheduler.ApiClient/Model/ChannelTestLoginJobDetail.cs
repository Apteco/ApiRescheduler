...
{
    /// <summary>
    /// Details for a job to test the login for a peoplestage channel
    /// </summary>
    [DataContract]
        public partial class ChannelTestLoginJobDetail :  IEquatable<ChannelTestLoginJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ChannelTestLoginJobDetail" /> class.
        /// </summary>
        /// <param name="success">If present, whether the login test succeeded or not.</param>
        /// <param name="messages">If present, any status messages associated with the login test.</param>
        ...
        public ChannelTestLoginJobDetail(bool? success = default(bool?), List<string> messages = default(List<string>), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ChannelTestLoginJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for ChannelTestLoginJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// If present, whether the login test succeeded or not
        /// </summary>
        /// <value>If present, whether the login test succeeded or not</value>
        [DataMember(Name="success", EmitDefaultValue=false)]
        public bool? Success { get; set; }

        /// <summary>
        /// If present, any status messages associated with the login test
        /// </summary>
        /// <value>If present, any status messages associated with the login test</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ChannelTestLoginJobDetail {\n");
        ...
        {
            return this.Equals(input as ChannelTestLoginJobDetail);
        }

        /// <summary>
        /// Returns true if ChannelTestLoginJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ChannelTestLoginJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChannelTestLoginJobDetail input)
        {
            if (input == null)
                return false;
