...
{
    /// <summary>
    /// Details for a schedule based on days
    /// </summary>
    [DataContract]
        public partial class ScheduleInDays :  IEquatable<ScheduleInDays>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduleInDays" /> class.
        /// </summary>
        /// <param name="periodInDays">periodInDays.</param>
        /// <param name="includeWeekdays">includeWeekdays.</param>
        /// <param name="includeWeekends">includeWeekends.</param>
        ...
        public ScheduleInDays(int? periodInDays = default(int?), bool? includeWeekdays = default(bool?), bool? includeWeekends = default(bool?), ScheduleDateTypeEnum? scheduleDateType = default(ScheduleDateTypeEnum?), string timeOfDay = default(string), DateTimeAndZone start = default(DateTimeAndZone), DateTimeAndZone end = default(DateTimeAndZone), ScheduleDateRule scheduleDateRule = default(ScheduleDateRule), PredefinedDateRuleEnum? predefinedDateRule = default(PredefinedDateRuleEnum?), int? id = default(int?))
        {
        ...
        /// <summary>
        /// Gets or Sets IncludeWeekdays
        /// </summary>
        [DataMember(Name="includeWeekdays", EmitDefaultValue=false)]
        public bool? IncludeWeekdays { get; set; }

        /// <summary>
        /// Gets or Sets IncludeWeekends
        /// </summary>
        [DataMember(Name="includeWeekends", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ScheduleInDays {\n");
            sb.Append("  PeriodInDays: ").Append(PeriodInDays).Append("\n");
            sb.Append("  IncludeWeekdays: ").Append(IncludeWeekdays).Append("\n");
            sb.Append("  IncludeWeekends: ").Append(IncludeWeekends).Append("\n");
        ...
        {
            return this.Equals(input as ScheduleInDays);
        }

        /// <summary>
        /// Returns true if ScheduleInDays instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduleInDays to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduleInDays input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    (this.PeriodInDays != null &&
                    this.PeriodInDays.Equals(input.PeriodInDays))
                ) && 
                (
                    this.IncludeWeekdays == input.IncludeWeekdays ||
                    (this.IncludeWeekdays != null &&
                    this.IncludeWeekdays.Equals(input.IncludeWeekdays))
                ) && 
                (
                    this.IncludeWeekends == input.IncludeWeekends ||
                    (this.IncludeWeekends != null &&
                    this.IncludeWeekends.Equals(input.IncludeWeekends))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.IncludeWeekdays != null)
                    hashCode = hashCode * 59 + this.IncludeWeekdays.GetHashCode();
                if (this.IncludeWeekends != null)
                    hashCode = hashCode * 59 + this.IncludeWeekends.GetHashCode();
