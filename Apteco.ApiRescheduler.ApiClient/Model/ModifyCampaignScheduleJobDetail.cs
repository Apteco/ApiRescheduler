...
{
    /// <summary>
    /// Details for a job to modify the schedule for a peoplestage campaign
    /// </summary>
    [DataContract]
        public partial class ModifyCampaignScheduleJobDetail :  IEquatable<ModifyCampaignScheduleJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyCampaignScheduleJobDetail" /> class.
        /// </summary>
        /// <param name="scheduleSummary">scheduleSummary.</param>
        ...
        public ModifyCampaignScheduleJobDetail(CampaignScheduleSummary scheduleSummary = default(CampaignScheduleSummary), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ModifyCampaignScheduleJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for ModifyCampaignScheduleJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets ScheduleSummary
        /// </summary>
        [DataMember(Name="scheduleSummary", EmitDefaultValue=false)]
        public CampaignScheduleSummary ScheduleSummary { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyCampaignScheduleJobDetail {\n");
            sb.Append("  ScheduleSummary: ").Append(ScheduleSummary).Append("\n");
        ...
        {
            return this.Equals(input as ModifyCampaignScheduleJobDetail);
        }

        /// <summary>
        /// Returns true if ModifyCampaignScheduleJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyCampaignScheduleJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyCampaignScheduleJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ScheduleSummary == input.ScheduleSummary ||
                    (this.ScheduleSummary != null &&
                    this.ScheduleSummary.Equals(input.ScheduleSummary))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ScheduleSummary != null)
                    hashCode = hashCode * 59 + this.ScheduleSummary.GetHashCode();
                if (this.Id != null)
