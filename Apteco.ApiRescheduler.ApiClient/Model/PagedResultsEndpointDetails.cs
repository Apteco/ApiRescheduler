...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsEndpointDetails :  IEquatable<PagedResultsEndpointDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsEndpointDetails" /> class.
        /// </summary>
        ...
        public PagedResultsEndpointDetails(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<EndpointDetails> _list = default(List<EndpointDetails>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsEndpointDetails and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsEndpointDetails and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsEndpointDetails and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsEndpointDetails and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<EndpointDetails> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsEndpointDetails {\n");
        ...
        {
            return this.Equals(input as PagedResultsEndpointDetails);
        }

        /// <summary>
        /// Returns true if PagedResultsEndpointDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsEndpointDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsEndpointDetails input)
        {
            if (input == null)
                return false;
