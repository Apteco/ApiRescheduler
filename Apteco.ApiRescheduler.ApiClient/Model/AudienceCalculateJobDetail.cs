...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AudienceCalculateJobDetail :  IEquatable<AudienceCalculateJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AudienceCalculateJobDetail" /> class.
        /// </summary>
        /// <param name="audienceResult">audienceResult.</param>
        ...
        public AudienceCalculateJobDetail(AudienceResultDetail audienceResult = default(AudienceResultDetail), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AudienceCalculateJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for AudienceCalculateJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets AudienceResult
        /// </summary>
        [DataMember(Name="audienceResult", EmitDefaultValue=false)]
        public AudienceResultDetail AudienceResult { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AudienceCalculateJobDetail {\n");
            sb.Append("  AudienceResult: ").Append(AudienceResult).Append("\n");
        ...
        {
            return this.Equals(input as AudienceCalculateJobDetail);
        }

        /// <summary>
        /// Returns true if AudienceCalculateJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of AudienceCalculateJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AudienceCalculateJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.AudienceResult == input.AudienceResult ||
                    (this.AudienceResult != null &&
                    this.AudienceResult.Equals(input.AudienceResult))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.AudienceResult != null)
                    hashCode = hashCode * 59 + this.AudienceResult.GetHashCode();
                if (this.Id != null)
