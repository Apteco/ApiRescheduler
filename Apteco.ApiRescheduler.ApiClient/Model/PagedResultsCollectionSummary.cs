...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsCollectionSummary :  IEquatable<PagedResultsCollectionSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsCollectionSummary" /> class.
        /// </summary>
        ...
        public PagedResultsCollectionSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<CollectionSummary> _list = default(List<CollectionSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsCollectionSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsCollectionSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsCollectionSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsCollectionSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<CollectionSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsCollectionSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsCollectionSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsCollectionSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsCollectionSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsCollectionSummary input)
        {
            if (input == null)
                return false;
