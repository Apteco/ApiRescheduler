...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsJobSummary :  IEquatable<PagedResultsJobSummary>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsJobSummary" /> class.
        /// </summary>
        ...
        public PagedResultsJobSummary(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<JobSummary> _list = default(List<JobSummary>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsJobSummary and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsJobSummary and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsJobSummary and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsJobSummary and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<JobSummary> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsJobSummary {\n");
        ...
        {
            return this.Equals(input as PagedResultsJobSummary);
        }

        /// <summary>
        /// Returns true if PagedResultsJobSummary instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsJobSummary to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsJobSummary input)
        {
            if (input == null)
                return false;
