...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ServiceLogPackageRequest :  IEquatable<ServiceLogPackageRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceLogPackageRequest" /> class.
        /// </summary>
        ...
        public ServiceLogPackageRequest(bool? includeExtendedLogs = default(bool?), bool? includeFs32SvrLogs = default(bool?), int? numberOfDaysWorthOfFs32SvrLogs = default(int?))
        {
            // to ensure "includeExtendedLogs" is required (not null)
            if (includeExtendedLogs == null)
            {
                throw new InvalidDataException("includeExtendedLogs is a required property for ServiceLogPackageRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("includeFs32SvrLogs is a required property for ServiceLogPackageRequest and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("numberOfDaysWorthOfFs32SvrLogs is a required property for ServiceLogPackageRequest and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ServiceLogPackageRequest {\n");
        ...
        {
            return this.Equals(input as ServiceLogPackageRequest);
        }

        /// <summary>
        /// Returns true if ServiceLogPackageRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ServiceLogPackageRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceLogPackageRequest input)
        {
            if (input == null)
                return false;
