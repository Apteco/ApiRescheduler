...
{
    /// <summary>
    /// Details for a job to modify the journey for a peoplestage campaign
    /// </summary>
    [DataContract]
        public partial class ModifyCampaignJourneyJobDetail :  IEquatable<ModifyCampaignJourneyJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyCampaignJourneyJobDetail" /> class.
        /// </summary>
        /// <param name="journeySummary">journeySummary.</param>
        ...
        public ModifyCampaignJourneyJobDetail(CampaignJourneySummary journeySummary = default(CampaignJourneySummary), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ModifyCampaignJourneyJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for ModifyCampaignJourneyJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// Gets or Sets JourneySummary
        /// </summary>
        [DataMember(Name="journeySummary", EmitDefaultValue=false)]
        public CampaignJourneySummary JourneySummary { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyCampaignJourneyJobDetail {\n");
            sb.Append("  JourneySummary: ").Append(JourneySummary).Append("\n");
        ...
        {
            return this.Equals(input as ModifyCampaignJourneyJobDetail);
        }

        /// <summary>
        /// Returns true if ModifyCampaignJourneyJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyCampaignJourneyJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyCampaignJourneyJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.JourneySummary == input.JourneySummary ||
                    (this.JourneySummary != null &&
                    this.JourneySummary.Equals(input.JourneySummary))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.JourneySummary != null)
                    hashCode = hashCode * 59 + this.JourneySummary.GetHashCode();
                if (this.Id != null)
