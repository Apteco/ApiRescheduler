...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PagedResultsDeliveryReport :  IEquatable<PagedResultsDeliveryReport>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedResultsDeliveryReport" /> class.
        /// </summary>
        ...
        public PagedResultsDeliveryReport(int? offset = default(int?), int? count = default(int?), int? totalCount = default(int?), List<DeliveryReport> _list = default(List<DeliveryReport>))
        {
            // to ensure "offset" is required (not null)
            if (offset == null)
            {
                throw new InvalidDataException("offset is a required property for PagedResultsDeliveryReport and cannot be null");
            }
            else
            {
                this.Offset = offset;
            ...
            if (count == null)
            {
                throw new InvalidDataException("count is a required property for PagedResultsDeliveryReport and cannot be null");
            }
            else
            {
                this.Count = count;
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PagedResultsDeliveryReport and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for PagedResultsDeliveryReport and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<DeliveryReport> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedResultsDeliveryReport {\n");
        ...
        {
            return this.Equals(input as PagedResultsDeliveryReport);
        }

        /// <summary>
        /// Returns true if PagedResultsDeliveryReport instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedResultsDeliveryReport to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedResultsDeliveryReport input)
        {
            if (input == null)
                return false;
