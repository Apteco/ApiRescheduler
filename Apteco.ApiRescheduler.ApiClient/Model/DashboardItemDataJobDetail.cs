...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DashboardItemDataJobDetail :  IEquatable<DashboardItemDataJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DashboardItemDataJobDetail" /> class.
        /// </summary>
        /// <param name="dashboardItemData">dashboardItemData.</param>
        ...
        public DashboardItemDataJobDetail(DashboardItemDataResultDetail dashboardItemData = default(DashboardItemDataResultDetail), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for DashboardItemDataJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for DashboardItemDataJobDetail and cannot be null");
            }
            else
            {
                this.IsComplete = isComplete;
            }
            this.DashboardItemData = dashboardItemData;
        ...
        /// <summary>
        /// Gets or Sets DashboardItemData
        /// </summary>
        [DataMember(Name="dashboardItemData", EmitDefaultValue=false)]
        public DashboardItemDataResultDetail DashboardItemData { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DashboardItemDataJobDetail {\n");
            sb.Append("  DashboardItemData: ").Append(DashboardItemData).Append("\n");
        ...
        {
            return this.Equals(input as DashboardItemDataJobDetail);
        }

        /// <summary>
        /// Returns true if DashboardItemDataJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of DashboardItemDataJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DashboardItemDataJobDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.DashboardItemData == input.DashboardItemData ||
                    (this.DashboardItemData != null &&
                    this.DashboardItemData.Equals(input.DashboardItemData))
                ) && 
                (
                    this.Id == input.Id ||
                    (this.Id != null &&
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.DashboardItemData != null)
                    hashCode = hashCode * 59 + this.DashboardItemData.GetHashCode();
                if (this.Id != null)
