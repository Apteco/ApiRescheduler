...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyItemsModifyVelocity :  IEquatable<ModifyItemsModifyVelocity>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyItemsModifyVelocity" /> class.
        /// </summary>
        ...
        public ModifyItemsModifyVelocity(bool? returnModifiedItem = default(bool?), List<ModifyVelocity> _list = default(List<ModifyVelocity>))
        {
            // to ensure "returnModifiedItem" is required (not null)
            if (returnModifiedItem == null)
            {
                throw new InvalidDataException("returnModifiedItem is a required property for ModifyItemsModifyVelocity and cannot be null");
            }
            else
            {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for ModifyItemsModifyVelocity and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ModifyVelocity> _List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifyItemsModifyVelocity {\n");
        ...
        {
            return this.Equals(input as ModifyItemsModifyVelocity);
        }

        /// <summary>
        /// Returns true if ModifyItemsModifyVelocity instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyItemsModifyVelocity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyItemsModifyVelocity input)
        {
            if (input == null)
                return false;
