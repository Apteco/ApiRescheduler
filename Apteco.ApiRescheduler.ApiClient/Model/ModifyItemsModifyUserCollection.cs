...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
        ...
        public partial class ModifyItemsModifyUserCollection :  IEquatable<ModifyItemsModifyUserCollection>
    {
        ...
        public ModifyItemsModifyUserCollection(bool? returnModifiedItem = default(bool?), List<ModifyUserCollection> _list = default(List<ModifyUserCollection>))
        {
            ...
            if (_list == null)
            {
                throw new InvalidDataException("_list is a required property for ModifyItemsModifyUserCollection and cannot be null");
            }
            else
            {
                this._List = _list;
        ...
        public List<ModifyUserCollection> _List { get; set; }
