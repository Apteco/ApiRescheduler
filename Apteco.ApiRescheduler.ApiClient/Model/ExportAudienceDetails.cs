...
namespace Apteco.ApiRescheduler.ApiClient.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExportAudienceDetails :  IEquatable<ExportAudienceDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportAudienceDetails" /> class.
        /// </summary>
        ...
        public ExportAudienceDetails(long? maximumNumberOfRowsToBrowse = default(long?), bool? returnBrowseRows = default(bool?), string path = default(string), string filename = default(string), Output output = default(Output), List<Column> columns = default(List<Column>), bool? generateUrnFile = default(bool?))
        {
            // to ensure "maximumNumberOfRowsToBrowse" is required (not null)
            if (maximumNumberOfRowsToBrowse == null)
            {
                throw new InvalidDataException("maximumNumberOfRowsToBrowse is a required property for ExportAudienceDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("returnBrowseRows is a required property for ExportAudienceDetails and cannot be null");
            }
            else
            {
            ...
            if (columns == null)
            {
                throw new InvalidDataException("columns is a required property for ExportAudienceDetails and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("generateUrnFile is a required property for ExportAudienceDetails and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExportAudienceDetails {\n");
        ...
        {
            return this.Equals(input as ExportAudienceDetails);
        }

        /// <summary>
        /// Returns true if ExportAudienceDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportAudienceDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportAudienceDetails input)
        {
            if (input == null)
                return false;
