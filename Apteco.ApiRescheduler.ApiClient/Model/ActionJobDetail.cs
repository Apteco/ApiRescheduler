...
{
    /// <summary>
    /// Details for a job to action a peoplestage element
    /// </summary>
    [DataContract]
        public partial class ActionJobDetail :  IEquatable<ActionJobDetail>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ActionJobDetail" /> class.
        /// </summary>
        /// <param name="elementId">The id of the PeopleStage element being actioned upon.</param>
        ...
        public ActionJobDetail(string elementId = default(string), int? id = default(int?), bool? isComplete = default(bool?), bool? isCancelled = default(bool?), int? queuePosition = default(int?), int? progress = default(int?), List<ServerMessage> serverMessages = default(List<ServerMessage>))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for ActionJobDetail and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (isComplete == null)
            {
                throw new InvalidDataException("isComplete is a required property for ActionJobDetail and cannot be null");
            }
            else
            {
        ...
        /// <summary>
        /// The id of the PeopleStage element being actioned upon
        /// </summary>
        /// <value>The id of the PeopleStage element being actioned upon</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActionJobDetail {\n");
        ...
        {
            return this.Equals(input as ActionJobDetail);
        }

        /// <summary>
        /// Returns true if ActionJobDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of ActionJobDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActionJobDetail input)
        {
            if (input == null)
                return false;
